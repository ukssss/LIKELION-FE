...
export const createSpinner = (size = 100, loadingMessage = "유저 정보를 가져오는중...") => {
  return /* html */ `
...
export const createEmptyCard = (size = 200, errorMessage = "표시할 데이터가 존재하지 않습니다 🤔") => {
  return /* html */ `
...
export const renderSpinner = (target, size, message) => {
  insertLast(target, createSpinner());
};

export const renderEmptyCard = (target, data) => {
